...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <!-- begin page-header -->
        <h1 class="page-header">Tableau de bord - <small>Système de gestion de stocks</small></h1>
        <!-- end page-header -->
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="widget widget-stats bg-blue">
                    ...
                    <div class="stats-info">
                        ...
                        <p>{{ \App\Models\Produit::count() }}</p>    
                    </div>
                    <div class="stats-link">
                        <a href="{{ url('/produits') }}">Voir détails <i class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- end col-3 -->
            ...
            <div class="col-xl-3 col-md-6">
                <div class="widget widget-stats bg-info">
                    ...
                    <div class="stats-info">
                        ...
                        <p>{{ \App\Models\Vente::count() }}</p>   
                    </div>
                    <div class="stats-link">
                        <a href="{{ url('/ventes') }}">Voir détails <i class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="widget widget-stats bg-orange">
                    ...
                    <div class="stats-link">
                        <a href="{{ url('/users') }}">Voir détails <i class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="widget widget-stats bg-red">
                    ...
                    <div class="stats-info">
                        <h4>Boutiques</h4>
                        <p>{{ \App\Models\Boutique::count() }}</p> 
                    </div>
                    <div class="stats-link">
                        <a href="{{ url('/boutiques') }}">Voir détails <i class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- end col-3 -->
                                ...
                                <ul class="media-list media-list-with-divider">
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object rounded" src="{{ asset('assets/img/gallery/gallery-1.jpg') }}" alt="" />
                                        </a>
                                    ...
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object rounded" src="{{ asset('assets/img/gallery/gallery-10.jpg') }}" alt="" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object rounded" src="{{ asset('assets/img/gallery/gallery-7.jpg') }}" alt="" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object rounded" src="{{ asset('assets/img/gallery/gallery-8.jpg') }}" alt="" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="hidden-sm text-center">
                                                <a href="javascript:;">
                                                    <img src="{{ asset('assets/img/product/product-1.png') }}" alt="" width="32px"  />
                                                </a>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm text-center">
                                                <a href="javascript:;">
                                                    <img src="{{ asset('assets/img/product/product-2.png') }}" alt="" width="32px" />
                                                </a>
                                            </td>
                                            <td class="text-nowrap">
                                                <h6><a href="javascript:;" class="text-inverse">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm text-center">
                                                <a href="javascript:;">
                                                    <img src="{{ asset('assets/img/product/product-3.png') }}" alt="" width="32px" />
                                                </a>
                                            </td>
                                            <td class="text-nowrap">
                                                <h6><a href="javascript:;" class="text-inverse">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm text-center">
                                                <a href="javascript:;">
                                                    <img src="{{ asset('assets/img/product/product-4.png') }}" alt="" width="32px" />
                                                </a>
                                            </td>
                                            <td class="text-nowrap">
                                                <h6><a href="javascript:;" class="text-inverse">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm text-center">
                                                <a href="javascript:;">
                                                    <img src="{{ asset('assets/img/product/product-5.png') }}" alt="" width="32px" />
                                                </a>
                                            </td>
                                            <td class="text-nowrap">
                                                <h6><a href="javascript:;" class="text-inverse">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
