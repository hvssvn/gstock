...
class CategorieController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $categorie->etat = "Activer";
            if ($categorie->save()) {
                return $this->successResponse($categorie, 'Insertion réussie');
            }
        } catch (Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $categorie->etat = "Activer";
            if ($categorie->save()) {
                return $this->successResponse($categorie, 'Mise à jour réussie');
            }
        } catch (Exception $e) {
    ...
    {
        try {
            $boutique = Categorie::findOrFail($id);
    ...
    public function destroy($id)
    {
        try {
            $categorie = Categorie::findOrFail($id);
            if ($categorie->delete()) {
                return $this->successResponse($categorie, 'Suppression réussie');
            }
        } catch (Exception $e) {
    ...
    public function show($id)
    {
        try {
            $categorie = Categorie::findOrFail($id);
             return $this->successResponse($categorie, 'Ressource trouvée');
        } catch (Exception $e) {
